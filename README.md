...
par(mfrow=c(1,2))
terra::plot(uv.List$uv.Rasts$nX, col= grDevices::gray(1:255/255), legend = FALSE, main = "Ridges.XY", xlim=c(600000,640000), ylim=c(5150000,5190000))
...
terra::plot(uv.List$uv.Rasts$nX, col= grDevices::gray(1:255/255), legend = FALSE, main = "Swales.XY", xlim=c(600000,640000), ylim=c(5150000,5190000))
terra::plot(uv.List$uv.Rasts$AvgEl, col= viridis::turbo(255, alpha=0.5), legend = FALSE, add = TRUE)
